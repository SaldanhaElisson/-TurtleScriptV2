from src.semantic_analyzer.syntatic_tree import RepeatLoop, Command, VariableDeclaration, Assignment, \
    BinaryExpression, IfStatement, WhileLoop, Literal, VariableReference, CommentNode
